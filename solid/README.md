# QR Code Component - Solid Implementation

Esta é a implementação em **Solid + TypeScript** do desafio QR Code Component do Frontend Mentor.
...
Esta versão foi construída utilizando Solid com foco em:
